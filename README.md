...
2. Определение габариты бота-автомобиля;
3. Реализация физики бота при езде по трассе (заносы, дрифты, скорость езды);
4. Реализация поведение бота при столкновении с неподвижным объектом реализованной карты (домом, столбом и пр.);
5. Реализация поведение бота при столкновении с другим ботом-автомобилем;
6. Реализация поведение бота на одной трассе с другим ботом.
